...
Skills do [Claude Code](https://claude.com/claude-code) para desenvolvimento **TOTVS Protheus (AdvPL/TLPP)** — e utilitários de produtividade do dia a dia com o próprio Claude Code.
...
| [sessao-retorno](sessao-retorno/) | Produtividade | Grava um `.bat` no Desktop que **reabre a janela do Claude Code que você fechou** (`claude --resume`), no diretório certo e com o histórico inteiro — restaurando também a cor da aba do Windows Terminal e o modo de permissão em que a sessão estava. Um atalho por sessão, sem duplicar. | 📖 [Guia completo](sessao-retorno/) |
